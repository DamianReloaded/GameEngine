...
Return value: LodePNG error code (0 means no error).
*/
unsigned lodepng_encode_memory(unsigned char** out, unsigned* outsize,
                               const unsigned char* image, unsigned w, unsigned h,
                               LodePNGColorType colortype, unsigned bitdepth);

/*Same as lodepng_encode_memory, but always encodes from 32-bit RGBA raw image.*/
unsigned lodepng_encode32(unsigned char** out, unsigned* outsize,
                          const unsigned char* image, unsigned w, unsigned h);

/*Same as lodepng_encode_memory, but always encodes from 24-bit RGB raw image.*/
unsigned lodepng_encode24(unsigned char** out, unsigned* outsize,
                          const unsigned char* image, unsigned w, unsigned h);
...
struct LodePNGDecompressSettings
{
  ...
  unsigned (*custom_zlib)(unsigned char**, unsigned*,
                          const unsigned char*, unsigned,
                          const LodePNGDecompressSettings*);
  /*use custom deflate decoder instead of built in one (default: null)
  if custom_zlib is used, custom_deflate is ignored since only the built in
  zlib function will call custom_deflate*/
  unsigned (*custom_inflate)(unsigned char**, unsigned*,
                             const unsigned char*, unsigned,
                             const LodePNGDecompressSettings*);
...
struct LodePNGCompressSettings /*deflate = compress*/
{
  ...
  if custom_zlib is used, custom_deflate is ignored since only the built in
  zlib function will call custom_deflate*/
  unsigned (*custom_deflate)(unsigned char**, unsigned*,
                             const unsigned char*, unsigned,
                             const LodePNGCompressSettings*);
...
typedef struct LodePNGInfo
{
  ...
  */
  unsigned text_num; /*the amount of texts in these char** buffers (there may be more texts in itext)*/
  ...
  */
  unsigned itext_num; /*the amount of international texts in this PNG*/
  ...
  */
  ...
  unsigned unknown_chunks_size[3]; /*size in bytes of the unknown chunks, given for protection*/
#endif /*LODEPNG_COMPILE_ANCILLARY_CHUNKS*/
} LodePNGInfo;
...
*/
unsigned lodepng_zlib_decompress(unsigned char** out, unsigned* outsize,
                                 const unsigned char* in, unsigned insize,
                                 const LodePNGDecompressSettings* settings);
#endif /*LODEPNG_COMPILE_DECODER*/
...
buffer and *outsize its size in bytes. out must be freed by user after usage.
*/
unsigned lodepng_zlib_compress(unsigned char** out, unsigned* outsize,
                               const unsigned char* in, unsigned insize,
